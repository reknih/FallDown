...
// jenachdem wie man die Koordinaten bzw. die Richtungen verändert wird geprüft ob die Rocket unter oder neben einem ist oder sonst wo :D
    ...
    public void aufsammeln(){
        ...
        if ( yellowPoint!= null)
        {                                                                      // heißt, dass ein yellowPoint vorhanden ist 
            if(yellowPointVorhanden ++ <= 5)
            {                                                                  // wenn zu den vorhandenen yellowPoints vnoch einer aufgenommen werden kann under Wert noch kleiner gleich 10 ist
